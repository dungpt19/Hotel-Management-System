...
public class frm_DoiMatKhau extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_MKcu.setFont(new java.awt.Font("Yu Gothic", 0, 14)); // NOI18N
        lbl_MKcu.setText("Old Password:");
        pnl_Nen.add(lbl_MKcu);
        lbl_MKcu.setBounds(40, 70, 110, 23);

        lbl_MKmoi.setFont(new java.awt.Font("Yu Gothic", 0, 14)); // NOI18N
        lbl_MKmoi.setText("New Password:");
        pnl_Nen.add(lbl_MKmoi);
        lbl_MKmoi.setBounds(40, 130, 153, 23);

        lbl_NhapLai.setFont(new java.awt.Font("Yu Gothic", 0, 14)); // NOI18N
        lbl_NhapLai.setText("Confirm New Password:");
        pnl_Nen.add(lbl_NhapLai);
        lbl_NhapLai.setBounds(40, 190, 180, 23);

        lbl_DoiMK.setFont(new java.awt.Font("Yu Gothic Medium", 1, 22)); // NOI18N
        lbl_DoiMK.setText("Password Setting");
        pnl_Nen.add(lbl_DoiMK);
        lbl_DoiMK.setBounds(100, 10, 200, 36);

        btn_Doi.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btn_Doi.setText("Change");
        ...
        pnl_Nen.add(btn_Doi);
        btn_Doi.setBounds(50, 260, 120, 30);
