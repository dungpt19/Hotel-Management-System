...
//                btn[i].setPreferredSize(new Dimension(200, 200));
                ...
                btn[i].setFont(new java.awt.Font("Tahoma", 1, 20));
                if (arrPhong.get(i).getTinhTrang().trim().equals("trong")) {
                    ...
                    String a = ("<html><div style=\"text-align: center;\">Room " + String.valueOf(arrPhong.get(i).getMaPhong()) + "<br>(" + arrPhong.get(i).getTenLoaiPhong() + ")<br>" + "Ready to be rented</div></html>");
                    btn[i].setText(a);
                ...
                if (arrPhong.get(i).getTinhTrang().trim().equals("sudung")) {
                    ...
                    String b = ("<html><div style=\"text-align: center;\">Room " + String.valueOf(arrPhong.get(i).getMaPhong()) + "<br>(" + arrPhong.get(i).getTenLoaiPhong() + ")<br>" + "In Use</div></html>");
                    btn[i].setText(b);
...
//                            if (nutbam == JOptionPane.OK_OPTION) {
                                ...
                                System.out.println("Room ID " + MaPhong);
...
//                            frm_ThuePhong.MaPhong = MaPhong;
                ...
                if (arrPhong.get(i).getTinhTrang().trim().equals("dondep")) {
                    ...
                    String MaPhong = arrPhong.get(i).getMaPhong();
                    String c = ("<html><div style=\"text-align: center;\">Room " + String.valueOf(arrPhong.get(i).getMaPhong()) + "<br>(" + arrPhong.get(i).getTenLoaiPhong() + ")<br>" + "Cleaning</div></html>");
                    btn[i].setText(c);
                    ...
                    btn[i].addActionListener(new ActionListener() {
                        @Override
                        public void actionPerformed(ActionEvent e) {
                            int nutbam = JOptionPane.showConfirmDialog(form, "Cleaning \n Do you want to complete the process?", "OPTION", JOptionPane.OK_CANCEL_OPTION);
                            if (nutbam == JOptionPane.OK_OPTION) {
                                System.out.println("Room ID " + MaPhong);
...
//                            frm_ThuePhong.MaPhong = MaPhong;
                ...
                if (arrPhong.get(i).getTinhTrang().trim().equals("dattruoc")) {
                    ...
                    String MaPhong = arrPhong.get(i).getMaPhong();
                    String c = ("<html><div style=\"text-align: center;\">Room " + String.valueOf(arrPhong.get(i).getMaPhong()) + "<br>(" + arrPhong.get(i).getTenLoaiPhong() + ")<br>" + "Pre-ordered</div></html>");
                    btn[i].setText(c);
                    btn[i].setToolTipText(c);
                    ...
                    btn[i].addActionListener(new ActionListener() {
                        @Override
                        public void actionPerformed(ActionEvent e) {
                            int nutbam = JOptionPane.showConfirmDialog(form, "Pre-Ordered Room \n Do you wish to rent now?", "OPTION", JOptionPane.YES_NO_CANCEL_OPTION);
                            if (nutbam == JOptionPane.YES_OPTION) {
                                ...
                                DAO.DAO_ThuePhong.UpdateDatTruocThanhThue("INCOMPLETE PAYMENT: ",MaPhong);                                
                                                                  
                                LoadLai();
                            } else if (nutbam==JOptionPane.CANCEL_OPTION) {//nếu hủy đặt phòng thì sẽ thanh toán đặt phòng và làm phòng trống
                                DAO.DAO_ThuePhong.UpdateDatTruocThanhThue("COMPLETED PAYMENT: ",MaPhong);
                                DAO.DAO_Phong.UpdateHoanThanhDonDep(MaPhong);
                                LoadLai();
                            }
    ...
    private void OpenDSThuePhong(String MaP) {
        ...
        try {
            ...
            frm.tab.add("List of Rent Rooms", pnl);
            frm.tab.setSelectedComponent(pnl);
        }
    ...
    private void initComponents() {
        ...
        btn_TrangThaiTrong.setText("Empty Room");
        ...
        btn_TrangThaiSuDung.setText("In Use");
        ...
        btn_TrangThaiDon.setText("Cleaning");
        ...
        btn_DatTruoc.setText("Pre-Ordered");
...
//        FillPhong(3);
    ...
    private void btn_LocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_LocActionPerformed
        ...
        System.out.println("Floor " + tang);

        if (rab_giuongdon.isSelected()) {
            arrPhong.clear();
            pnl.removeAll();
            System.out.println("Added 1 SingleBed");
        ...
        if (rab_2giuongdon.isSelected()) {
            arrPhong.clear();
            pnl.removeAll();
            System.out.println("Added 2 SingleBed");
        ...
        if (rab_giuongdoi.isSelected()) {
            arrPhong.clear();
            pnl.removeAll();
            System.out.println("Added 1 DoubleBed");
