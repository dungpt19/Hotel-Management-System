...
public class pnl_DSThuePhong extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tbl_DSThuePhong.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        tbl_DSThuePhong.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "CUSTOMER", "ROOM", "TYPE", "RENT DATE"
            }
        ));
        ...
        lbl_DSThuePhong.setText("List of Rented Room");
        ...
        lbl_ChiTiet.setFont(new java.awt.Font("Yu Gothic Medium", 1, 18)); // NOI18N
        lbl_ChiTiet.setText("Details");
        pnl3.add(lbl_ChiTiet, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        btn_ThanhToan.setBackground(new java.awt.Color(51, 255, 255));
        btn_ThanhToan.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        btn_ThanhToan.setText("PAY UP");
        ...
        pnl3.add(btn_ThanhToan, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 600, 460, 42));
        ...
        pnl3.add(btn_Sua, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, 90, 30));

        lbl_MaDatPhong.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_MaDatPhong.setText("Rent Room ID");
        ...
        lbl_TenKhachHang.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_TenKhachHang.setText("Customer Name");
        pnl3.add(lbl_TenKhachHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, -1));

        lbl_Phong.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_Phong.setText("Room");
        pnl3.add(lbl_Phong, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, -1));

        lbl_NgayThue.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_NgayThue.setText("Rent date:");
        pnl3.add(lbl_NgayThue, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, -1, 20));

        lbl_NgayRaDuKien.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_NgayRaDuKien.setText("Check-out Time Estimated:");
        pnl3.add(lbl_NgayRaDuKien, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));

        lbl_SoNguoi.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_SoNguoi.setText("People");
        pnl3.add(lbl_SoNguoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, -1, -1));

        lbl_NguoiTao.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_NguoiTao.setText("Creator");
        pnl3.add(lbl_NguoiTao, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, -1, -1));

        txt_TenKH.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        pnl3.add(txt_TenKH, new org.netbeans.lib.awtextra.AbsoluteConstraints(161, 49, 250, -1));

        txt_Phong.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        pnl3.add(txt_Phong, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 60, -1));

        txt_NgayThue.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        pnl3.add(txt_NgayThue, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, 160, -1));

        txt_NgayRa.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        pnl3.add(txt_NgayRa, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 165, -1));
        ...
        btn_DichVU.setBackground(new java.awt.Color(51, 255, 255));
        btn_DichVU.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        btn_DichVU.setText("OPEN SERVICE");
        btn_DichVU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_DichVUActionPerformed(evt);
            }
        });
        pnl3.add(btn_DichVU, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 570, -1, -1));

        lbl_Vuot.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_Vuot.setText("Overruled:");
        pnl3.add(lbl_Vuot, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 170, -1, 20));
        pnl3.add(lbl_NgayVuot, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 47, 23));

        lbl_Ngay.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_Ngay.setText("Days");
        pnl3.add(lbl_Ngay, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 40, 20));

        lbl_TongCong2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_TongCong2.setText("Total:");
        pnl3.add(lbl_TongCong2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 540, -1, -1));

        lbl_TienPhong2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_TienPhong2.setText("Room Rented");
        pnl3.add(lbl_TienPhong2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, -1, -1));

        lbl_TienDV2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_TienDV2.setText("Serivces");
        pnl3.add(lbl_TienDV2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, -1, -1));

        lbl_TienPhong.setBackground(new java.awt.Color(0, 204, 255));
        lbl_TienPhong.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_TienPhong.setText("0");
        lbl_TienPhong.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 255), new java.awt.Color(102, 102, 102)));
        lbl_TienPhong.setOpaque(true);
        pnl3.add(lbl_TienPhong, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, 140, 20));

        lbl_TienDV.setBackground(new java.awt.Color(0, 204, 255));
        lbl_TienDV.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_TienDV.setText("0");
        lbl_TienDV.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 255), new java.awt.Color(102, 102, 102)));
        lbl_TienDV.setOpaque(true);
        pnl3.add(lbl_TienDV, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 440, 140, 20));

        lbl_vnd.setText("$");
        pnl3.add(lbl_vnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, -1, -1));

        lbl_vnd2.setText("$");
        pnl3.add(lbl_vnd2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 480, -1, -1));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        pnl3.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 510, 227, 10));

        lbl_TongCong.setBackground(new java.awt.Color(0, 204, 255));
        lbl_TongCong.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_TongCong.setText("0");
        lbl_TongCong.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 255), new java.awt.Color(102, 102, 102)));
        lbl_TongCong.setOpaque(true);
        pnl3.add(lbl_TongCong, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 540, 140, 20));
        ...
        lbl_PhuThuCheckIn.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_PhuThuCheckIn.setText("Early Check-in Surcharge");
        pnl3.add(lbl_PhuThuCheckIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, -1, -1));

        lbl_PhuThuCheckOut.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_PhuThuCheckOut.setText("Late Check-out Surcharge");
        pnl3.add(lbl_PhuThuCheckOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, -1, -1));

        txt_CheckIn.setBackground(new java.awt.Color(0, 204, 255));
        txt_CheckIn.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_CheckIn.setText("0");
        txt_CheckIn.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 255), new java.awt.Color(102, 102, 102)));
        txt_CheckIn.setFocusable(false);
        pnl3.add(txt_CheckIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 360, 140, 20));

        txt_checkout.setBackground(new java.awt.Color(0, 204, 255));
        txt_checkout.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_checkout.setText("0");
        txt_checkout.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 255), new java.awt.Color(102, 102, 102)));
        txt_checkout.setFocusable(false);
        pnl3.add(txt_checkout, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 400, 140, 20));

        lbl_Dau.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_Dau.setText("-");
        pnl3.add(lbl_Dau, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 470, 10, 10));

        lbl_Dau2.setText("+");
        pnl3.add(lbl_Dau2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 330, -1, -1));

        lbl_Dau3.setText("+");
        pnl3.add(lbl_Dau3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 380, -1, -1));

        lbl_TienCoc2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_TienCoc2.setText("Deposit");
        pnl3.add(lbl_TienCoc2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, -1, -1));

        lbl_TienCoc.setBackground(new java.awt.Color(0, 204, 255));
        lbl_TienCoc.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_TienCoc.setText("0");
        lbl_TienCoc.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 255), new java.awt.Color(102, 102, 102)));
        lbl_TienCoc.setOpaque(true);
        pnl3.add(lbl_TienCoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 480, 140, 20));

        lbl_Dau4.setText("+");
        pnl3.add(lbl_Dau4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 420, -1, -1));

        lbl_vnd4.setText("$");
        pnl3.add(lbl_vnd4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 440, -1, -1));

        lbl_vnd5.setText("$");
        pnl3.add(lbl_vnd5, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 360, -1, -1));

        lbl_vnd6.setText("$");
        pnl3.add(lbl_vnd6, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 400, -1, -1));

        lbl_KM.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        lbl_KM.setText("Promotion:");
        pnl3.add(lbl_KM, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 520, -1, -1));

        txt_GiamGia.setBackground(new java.awt.Color(51, 204, 255));
        ...
        pnl3.add(txt_GiamGia, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 540, 60, 20));

        lbl_PhanTram.setText("%");
        pnl3.add(lbl_PhanTram, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 540, -1, 20));

        javax.swing.GroupLayout pnl2Layout = new javax.swing.GroupLayout(pnl2);
        pnl2.setLayout(pnl2Layout);
        pnl2Layout.setHorizontalGroup(
            pnl2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnl3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 485, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void TinhTienTheoGio() {
        ...
        System.out.println("Rent Reciept" + HD.getSoGioThue());
        //
...
//            System.out.println("Ngày ở là " + soNgay);
    ...
    private void LamMoi() {
        ...
        frm.tab.add("List of Rented Room", pnl);
        frm.tab.setSelectedComponent(pnl);
    }
