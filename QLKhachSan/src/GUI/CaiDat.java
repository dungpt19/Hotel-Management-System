...
public class CaiDat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnl_Nen2.setBackground(new java.awt.Color(204, 255, 255));
        ...
        lbl_TimeCheckout.setFont(new java.awt.Font("Yu Gothic Medium", 0, 16)); // NOI18N
        lbl_TimeCheckout.setText("Check-out time");
        pnl_Nen2.add(lbl_TimeCheckout, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, -1, 30));

        lbl_PhanTram5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_PhanTram5.setText("% Price ( $ )");
        lbl_PhanTram5.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        pnl_Nen2.add(lbl_PhanTram5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, -1, 20));

        lbl_PhuThuCheckOut2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 16)); // NOI18N
        lbl_PhuThuCheckOut2.setText("Second early check-in surcharge");
        lbl_PhuThuCheckOut2.setToolTipText("phụ thu khi checkin sớm trước giờ checkin mốc 1 ");
        pnl_Nen2.add(lbl_PhuThuCheckOut2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 480, -1, 30));

        txt_PhuPhu4.setBackground(new java.awt.Color(204, 204, 204));
        txt_PhuPhu4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_PhuPhu4ActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_PhuPhu4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 520, 130, 30));

        lbl_PhanTram4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_PhanTram4.setText("% Price ( $ )");
        lbl_PhanTram4.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        pnl_Nen2.add(lbl_PhanTram4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 530, -1, 20));

        lbl_TimeCheckIn.setFont(new java.awt.Font("Yu Gothic Medium", 0, 16)); // NOI18N
        lbl_TimeCheckIn.setText("Check-in time");
        pnl_Nen2.add(lbl_TimeCheckIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, -1, 30));

        txt_TimeCheckOut.setBackground(new java.awt.Color(204, 204, 204));
        pnl_Nen2.add(txt_TimeCheckOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 350, 140, 30));

        lbl_PhuThuCheckIn.setFont(new java.awt.Font("Yu Gothic Medium", 0, 16)); // NOI18N
        lbl_PhuThuCheckIn.setText("First early check-in surcharge");
        lbl_PhuThuCheckIn.setToolTipText("phụ thu khi checkin sớm trước giờ checkin mốc 1 ");
        pnl_Nen2.add(lbl_PhuThuCheckIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 350, 30));

        lbl_PhuThuCheckOut.setFont(new java.awt.Font("Yu Gothic Medium", 0, 16)); // NOI18N
        lbl_PhuThuCheckOut.setText("First early check-out surcharge");
        lbl_PhuThuCheckOut.setToolTipText("phụ thu khi checkin sớm trước giờ checkin mốc 1 ");
        pnl_Nen2.add(lbl_PhuThuCheckOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, -1, 30));

        txt_PhuThu3.setBackground(new java.awt.Color(204, 204, 204));
        txt_PhuThu3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_PhuThu3ActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_PhuThu3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 430, 130, 30));

        lbl_PhanTram3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_PhanTram3.setText("% Price ( $ )");
        lbl_PhanTram3.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        pnl_Nen2.add(lbl_PhanTram3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, -1, 20));

        lbl_PhanTram2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_PhanTram2.setText("% Price ( $ )");
        lbl_PhanTram2.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        pnl_Nen2.add(lbl_PhanTram2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 440, -1, 20));

        txt_CheckOut2.setBackground(new java.awt.Color(204, 204, 204));
        txt_CheckOut2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_CheckOut2ActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_CheckOut2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, 80, 30));

        txt_CheckOut.setBackground(new java.awt.Color(204, 204, 204));
        txt_CheckOut.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_CheckOutActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_CheckOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 430, 80, 30));

        lbl_Tieng.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_Tieng.setText("Hours");
        pnl_Nen2.add(lbl_Tieng, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 260, -1, -1));

        lbl_Tieng2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_Tieng2.setText("Hours");
        pnl_Nen2.add(lbl_Tieng2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 530, -1, -1));

        lbl_PhuThuCheckIn2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 16)); // NOI18N
        lbl_PhuThuCheckIn2.setText("Second early check-in surcharge");
        lbl_PhuThuCheckIn2.setToolTipText("phụ thu khi checkin sớm trước giờ checkin mốc 1 ");
        pnl_Nen2.add(lbl_PhuThuCheckIn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, 30));

        txt_CheckIn.setBackground(new java.awt.Color(204, 204, 204));
        txt_CheckIn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_CheckInActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_CheckIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 140, 30));

        txt_CheckInSom.setBackground(new java.awt.Color(204, 204, 204));
        txt_CheckInSom.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_CheckInSomActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_CheckInSom, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 80, 30));

        txt_PhuThu.setBackground(new java.awt.Color(204, 204, 204));
        pnl_Nen2.add(txt_PhuThu, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 130, 30));

        txt_CheckInSom3.setBackground(new java.awt.Color(204, 204, 204));
        txt_CheckInSom3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_CheckInSom3ActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_CheckInSom3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 80, 30));

        txt_PhuThu2.setBackground(new java.awt.Color(204, 204, 204));
        txt_PhuThu2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_PhuThu2ActionPerformed(evt);
            }
        });
        pnl_Nen2.add(txt_PhuThu2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 130, 30));

        lbl_Tieng3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_Tieng3.setText("Hours");
        pnl_Nen2.add(lbl_Tieng3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, -1, -1));

        lbl_Tieng4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_Tieng4.setText("Hours");
        pnl_Nen2.add(lbl_Tieng4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 440, -1, -1));

        lbl_Luu.setBackground(new java.awt.Color(102, 255, 255));
        lbl_Luu.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_Luu.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_Luu.setText("Save");
        lbl_Luu.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        pnl_Nen2.add(lbl_Luu, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 570, 150, 30));

        lbl_CaiDat.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
        lbl_CaiDat.setText("Setting");
        ...
        lbl_Nen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HinhAnh/backgroud3.PNG"))); // NOI18N
        pnl_Nen2.add(lbl_Nen, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 410, 560));
