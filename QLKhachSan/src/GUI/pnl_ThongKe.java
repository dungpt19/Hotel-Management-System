...
public class pnl_ThongKe extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnl1.setBackground(new java.awt.Color(102, 255, 255));
        pnl1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lbl_ThongKeHD.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        lbl_ThongKeHD.setText("Reciept Statistic");
        pnl1.add(lbl_ThongKeHD, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, -1, -1));

        add(pnl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 470, 80));
        ...
        tbl_HoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Receipt ID", "Room Costs", "Service Costs", "Total", "Surcharge", "Payment Date"
            }
        ));
        jScrollPane1.setViewportView(tbl_HoaDon);

        pnl2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 470, 370));
        pnl2.add(date_ngay1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 130, -1));
        ...
        pnl2.add(date_ngay2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 130, -1));

        btn_Xem.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btn_Xem.setText("View");
        ...
        pnl2.add(btn_Xem, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 10, -1, -1));
        ...
        pnl3.setForeground(new java.awt.Color(0, 102, 102));

        lbl_TienDV.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbl_TienDV.setText("Service Price:");

        lbl_TienPhong.setBackground(new java.awt.Color(153, 153, 153));
        ...
        lbl_DV.setBackground(new java.awt.Color(153, 153, 153));
        ...
        lbl_TongDoanhThu.setText("Total Income:");

        lbl_Tong.setBackground(new java.awt.Color(153, 153, 153));
        ...
        lbl_SoHD.setBackground(new java.awt.Color(153, 153, 153));
        ...
        pnl2.add(pnl3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, 470, 180));

        add(pnl2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 470, 620));

        pnl4.setBackground(new java.awt.Color(51, 153, 255));
        pnl4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pnl5.setBackground(new java.awt.Color(102, 255, 255));

        lbl_ThongKeLuong.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        lbl_ThongKeLuong.setText("Staffs's Salary Statistic");
        ...
        pnl4.add(pnl5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 510, 80));
        ...
        tbl_Luong.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Staff Name", "Days Off", "Days Worked", "Recieved Date", "Total"
            }
        ));
        jScrollPane2.setViewportView(tbl_Luong);

        pnl4.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 500, 370));

        pnl6.setBackground(new java.awt.Color(0, 204, 204));
        ...
        lbl_TongLuong2.setText("Total Salary:");

        lbl_TongLuong.setBackground(new java.awt.Color(153, 153, 153));
        ...
        pnl4.add(pnl6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 500, 500, 180));
        ...
        add(pnl4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 0, -1, 710));
