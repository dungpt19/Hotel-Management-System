...
public class DAO_Phong {
    ...
    public static ResultSet LayPhong(int TrangThai) {
        ...
        if (TrangThai == 0) {
            ...
            sql = "SELECT * FROM Phong where TinhTrang like N'Empty'";
        } else if (TrangThai == 2) {
            sql = "SELECT * FROM Phong where TinhTrang like N'InUse'";
        } else if (TrangThai == 3) {
            sql = "SELECT * FROM Phong where TinhTrang like N'Cleaning'";
        } else if (TrangThai == 4) {
            sql = "SELECT * FROM Phong where TinhTrang like N'PreOrdered'";
        } else {
        }
...
//    }
    ...
    public static void ThemPhong(DTO.DTO_Phong P) {
        ...
        if (kq > 0) {
            thongbao.thongbao("Add Successful", "");
        } else {
            thongbao.thongbao("Add Error Occurred", "");
        }
    }
    ...
    public static void Sua(DTO.DTO_Phong P) {
        ...
        int kq = connection.ExecuteTruyVan(sql);
        if (kq > 0) {
            thongbao.thongbao("Edit Successful", "");
        } else {
            thongbao.thongbao("Edit Error Occurred", "");
        }
    }
